...
import '../../widgets/items-pages.dart';

class TrialMainScreen extends StatefulWidget {
  const TrialMainScreen({super.key});

  @override
  State<TrialMainScreen> createState() => _TrialMainScreenState();
}

class _TrialMainScreenState extends State<TrialMainScreen> {
  double startedAt = 0;
